 ...
 * @since 2020
 */
public class ListaEnlazada <Node>{
    private Nodo first;
    private Nodo last;
    private int size = 0;
     ...
     * @param data Node
     */
    public void modify(int pos, Node data){
        if (isEmpty()){
     ...
     * @return Nodo
     */
    public Nodo removeByValue(Node data){
